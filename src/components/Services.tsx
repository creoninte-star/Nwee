...
function ServiceCard({ service, i, scrollYProgress, setSelectedService, isMobile }: any) {
  ...
  return (
    <motion.div
      ...
      className="absolute w-[280px] sm:w-[320px] bg-gradient-to-b from-white/90 to-[#f8f9fa]/90 backdrop-blur-2xl cursor-pointer border border-navy/40 rounded-3xl p-8 flex flex-col group hover:from-[#f0f4f8]/90 hover:to-[#e9ecef]/90 hover:border-navy/60 transition-all duration-500 overflow-hidden shadow-[0_0_20px_rgba(10,35,66,0.15)] pointer-events-auto will-change-transform transform-gpu"
      whileHover={{ scale: 1.05, y: -5, transition: { duration: 0.3 } }}
    >
      {/* Premium subtle inner gradient glow & border highlights */}
      <div className="absolute inset-0 bg-gradient-to-br from-navy/20 via-transparent to-navy-light/10 opacity-0 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none" />
      <div className="absolute top-0 inset-x-0 h-px bg-gradient-to-r from-transparent via-navy/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700" />
      <div className="absolute bottom-0 inset-x-0 h-px bg-gradient-to-r from-transparent via-navy-light/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700" />

      <div className="text-text/70 group-hover:text-navy transition-colors duration-500 mb-8 relative z-10 flex justify-center">
        <div className="p-4 rounded-full bg-navy/5 group-hover:bg-navy/10 transition-colors duration-500">
          <Icon size={40} strokeWidth={1.5} />
        </div>
      </div>
      <div className="relative z-10 text-center">
        <h3 className="text-xl font-sans font-medium tracking-wide text-navy mb-3 uppercase group-hover:scale-105 transition-transform duration-300">{service.title}</h3>
        <p className="text-text-muted font-sans text-xs leading-relaxed group-hover:text-navy/80 transition-colors duration-300">{service.desc}</p>
      </div>
    </motion.div>
  );
}
    ...
    <section ref={containerRef} id="services" className="h-[400vh] bg-background relative z-10">
      ...
      <div className="sticky top-0 h-screen w-full overflow-hidden flex flex-col items-center justify-center">
        ...
        <div className="absolute inset-0 pointer-events-none">
          ...
          >
            <h2 className="text-[25rem] font-display font-black tracking-tighter text-navy leading-none">
              SERVICES
            </h2>
          </motion.div>
          ...
          <motion.div 
            ...
            className="absolute top-1/4 -left-20 w-[600px] h-[600px] bg-navy/20 rounded-full blur-[120px]"
          />
          <motion.div 
        ...
        >
          <div className="relative w-48 h-48 md:w-64 md:h-64 rounded-full border border-navy/30 bg-white/40 backdrop-blur-xl flex items-center justify-center shadow-[0_0_60px_rgba(10,35,66,0.15)]">
            <div className="absolute inset-0 rounded-full bg-gradient-to-br from-navy/20 to-transparent blur-md"></div>
            <div className="absolute inset-2 rounded-full border border-navy/10 border-dashed animate-[spin_20s_linear_infinite]"></div>
            <Diamond size={64} className="text-navy animate-pulse" strokeWidth={1} />
          </div>
          <h3 className="mt-8 text-2xl md:text-3xl font-display font-bold uppercase tracking-widest text-navy">Nwee Core</h3>
          <p className="mt-2 text-navy/70 text-sm font-sans tracking-widest uppercase">Ecosystem</p>
        </motion.div>

        {/* Scroll Hints */}
        <motion.div 
          style={{ opacity: hintOpacity }}
          className="absolute bottom-12 text-navy/40 text-[10px] uppercase tracking-[0.3em] font-sans pointer-events-none"
        >
            ...
            >
              ...
              <div className="absolute top-8 md:top-12 right-8 md:right-12 z-[10001]">
                <button 
                  ...
                  className="group flex items-center gap-3 p-3 px-4 bg-navy/5 hover:bg-navy/20 text-navy hover:text-navy transition-all duration-300 rounded-full border border-navy/10 backdrop-blur-md"
                >
                ...
                <div className="w-full max-w-4xl flex flex-col lg:flex-row gap-12 lg:gap-24">
                  <div className="flex-1">
                    ...
                    <motion.button 
                      ...
                      onClick={() => setSelectedService(null)}
                      className="inline-flex items-center gap-2 uppercase tracking-widest text-xs font-bold font-sans text-navy border-b border-navy pb-1 hover:text-navy hover:border-navy transition-all duration-300"
                    >
                  ...
                  <motion.div 
                    ...
                    transition={{ delay: 0.4 }}
                    className="flex-1 bg-white/[0.03] border border-navy/10 p-1 rounded-3xl relative overflow-hidden hidden md:block min-h-[400px]"
                  >
                    ...
                    <div className="absolute bottom-8 left-8 text-[10px] text-navy tracking-[0.4em] uppercase font-sans">Featured Work / Case Study</div>
                  </motion.div>
                </div>
              </div>
            </motion.div>
